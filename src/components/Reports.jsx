              ...
              <PieChart width={400} height={300}>
                <Pie
                  data={[
                    {
                      name: "Excellent",
                      value: ratingSummary.reduce((sum, q) => sum + q.Excellent, 0),
                    },
                    {
                      name: "Good",
                      value: ratingSummary.reduce((sum, q) => sum + q.Good, 0),
                    },
                    {
                      name: "Average",
                      value: ratingSummary.reduce((sum, q) => sum + q.Average, 0),
                    },
                    {
                      name: "Poor",
                      value: ratingSummary.reduce((sum, q) => sum + q.Poor, 0),
                    },
                  ]}
                  cx="50%"
                  cy="50%"
                  ...
                  label
                >
                  {["Excellent", "Good", "Average", "Poor"].map((entry, index) => (
            ...
            {questionStats.map((q, index) => (
              <div key={index} className="summary-card">
                ...
                <div className="summary-right">
                  <p className="stars">{"★".repeat(q.stars)}</p>
                </div>
              </div>
            ))}
          </div>
